        ...
        <div className="proj-main-div flex w-full justify-center mt-10">
          <div className="proj-div border-2 p-3 border-gray-800 flex flex-col justify-center items-center w-1/4 rounded-3xl m-2">
            ...
            <div className="proj-buttons flex w-full justify-center">
              ...
              <a href="https://github.com/codebyayush/react-bootstrap-project/tree/improvise" target="_blank"><button className="border-2 border-gray-900 h-12 m-4 w-32 text-center rounded-full hover:text-white hover:bg-zinc-700 transition duration-700">Github</button></a>
            </div>
          </div>
          <div className="proj-div border-2 p-3 border-gray-800 flex flex-col justify-center items-center w-1/4 rounded-3xl m-2">
            <img
