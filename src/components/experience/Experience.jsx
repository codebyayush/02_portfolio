...
const Experience = () => {
  return (
    <>
      <div id='main-header' className='h-auto flex flex-col mb-24'>
        ...
        <h1 className="text-5xl font-bold mt-2">Experience</h1>
          ...
          <div id='main-div' className='flex w-full justify-center'>
            ...
            <div id='child-2' className=' border-2 border-gray-700 rounded-3xl mt-10 p-5 w-1/3 m-3'>
                <h1 id='header-2' className='text-3xl font-bold text-center '>Other Technologies</h1>
                <div id='skills' className='mt-5'>
                    <div id='article-container'>
                    <article>
                        <img src="/correct.png" alt="correct" className='h-7 w-7 mt-2'/>
                        <div >
                          <h2 className='font-medium '>TailwindCSS</h2>
                          <h2>Intermediate</h2>
                        </div>
                    </article>
                    <article>
                        <img src="/correct.png" alt="correct" className='h-7 w-7 mt-2'/>
                        <div >
                          <h2  className='font-medium '>Bootstrap</h2>
                          <h2>Intermediate</h2>
                        </div>
                    </article>
                    <article>
                        <img src="/correct.png" alt="correct" className='h-7 w-7 mt-2'/>
                        <div >
                          <h2  className='font-medium '>Git & Github</h2>
                          <h2>Intermediate</h2>
                        </div>
                    </article>
                    <article>
                    ...
                    <article>
                        <img src="/correct.png" alt="correct" className='h-7 w-7 mt-2'/>
                        <div >
                          <h2  className='font-medium '>Firebase</h2>
                          <h2>Intermediate</h2>
                        </div>
                    </article>
                    <article>
                        <img src="/correct.png" alt="correct" className='h-7 w-7 mt-2'/>
                        <div >
                          <h2  className='font-medium '>VS Code</h2>
                          <h2>Experienced</h2>
                        </div>
                    </article>
                    </div>
