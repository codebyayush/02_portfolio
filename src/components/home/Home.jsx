      ...
      <div id="home-div" className=" flex h-screen items-center justify-center text-center">
        ...
        <div>
          ...
          <div className="m-3">
            ...
            <a href="#Contact"><button className=" rounded-full bg-zinc-700 text-white font-medium  p-3  hover:text-black hover:bg-white border border-black transition duration-700">Contact Info</button></a>
          </div>
          <div className="flex h-10 justify-center">

          <a href="https://www.github.com/codebyayush" target="_blank">
                <img src="/github.png" alt="git" className="mr-4 ms-4 w-10 h-10 " />
              </a>
